...
namespace ArtFusionStudio.Areas.Admin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        {
            if (_context.Categories.FirstOrDefault(c => c.Name.ToLower().Replace(" ", "") == category.Name.ToLower().Replace(" ", "")) != null)
            {
                ModelState.AddModelError("Name", "Вече има такава категория");
            }
